...
const selectTriggerVariants = cva(
  'flex w-full items-center justify-between rounded-lg border bg-ait-white text-ait-body-md-regular transition-colors focus:outline-none focus:ring-2 focus:ring-ait-primary-500 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1',
  {
    variants: {
      variant: {
        default:
          'border-ait-neutral-300 text-ait-neutral-900 hover:border-ait-neutral-400',
        error:
          'border-ait-danger-500 text-ait-neutral-900 focus:ring-ait-danger-500',
      },
      size: {
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      'px-2 py-1.5 text-ait-caption-md-bold text-ait-neutral-900',
      className,
    )}
    {...props}
  />
